<script lang="ts">
	...
	const siteUrl = 'https://conary.io';
	const imageUrl = `${siteUrl}/brand/conary-social.png`;
	let canonicalUrl = $derived(path ? new URL(path, siteUrl).toString() : undefined);
</script>
...
<svelte:head>
	...
	<meta property="og:site_name" content="Conary" />
