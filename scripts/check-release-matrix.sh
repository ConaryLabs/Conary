...
require_job_match "$native_oracle_production_workflow" produce '\.package_oracle\.schema_version == 1[\s\S]*\.resolution_oracle\.schema_version == 2[\s\S]*projection_schema:4[\s\S]*projection_schema:2' 'native-oracle production exact package, resolution, and implementation schemas'
