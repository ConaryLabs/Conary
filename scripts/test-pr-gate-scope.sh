...
expect "markdown inside a crate runs the matrices" true "crates/conary-core/README.md\n"
expect "markdown inside a native fixture stage runs the matrices" true "apps/conary/tests/fixtures/native-lifecycle-parity/v1/stage/usr/share/doc/contract.md\n"
expect "markdown under .github skips" false ".github/PULL_REQUEST_TEMPLATE.md\n"
expect "nested docs markdown skips" false "docs/modules/remi.md\n"
