...
benchmark_remi_conversion() {
    ...
    raw_report="${work_root}/conversion-benchmark-v4.json"
    public_sidecar="${work_root}/conversion-benchmark-public-v2.json"
    ...
    jq -e '.schema_version == 4 and type == "object"' "$raw_report" >/dev/null ||
    ...
    jq -e \
        ...
        and .raw_report.schema_version == 4
