...
benchmark_remi_conversion() {
    ...
    raw_report="${work_root}/conversion-benchmark-v5.json"
    public_sidecar="${work_root}/conversion-benchmark-public-v3.json"
    ...
    jq -e '.schema_version == 5 and type == "object"' "$raw_report" >/dev/null ||
    ...
    jq -e \
        ...
        and .raw_report.schema_version == 5
