...
metadata in `Cargo.toml` plus the upstream `LICENSE.md` notice. The local change
is limited to raising their `quick-xml` dependency from `0.38` to `0.41` so the
release audit gate does not ship `RUSTSEC-2026-0194` or `RUSTSEC-2026-0195`.
