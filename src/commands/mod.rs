...
pub use bootstrap::{
    ...
    cmd_bootstrap_image, cmd_bootstrap_init, cmd_bootstrap_resume, cmd_bootstrap_run,
    cmd_bootstrap_seed, cmd_bootstrap_seed_adopted, cmd_bootstrap_status, cmd_bootstrap_system,
    cmd_bootstrap_temp_tools, cmd_bootstrap_tier2, cmd_bootstrap_verify_convergence,
};
