// apps/conary/src/commands/ccs/inspect/render.rs
//! Render non-authoritative package inspection facts.

use anyhow::Result;
use conary_core::ccs::UntrustedPackageInspection;
use conary_core::ccs::builder::{ComponentData, FileEntry};
use conary_core::payload::PayloadNodeKind;
use serde::Serialize;
use std::collections::HashMap;

/// Print package summary
pub(super) fn print_summary(pkg: &UntrustedPackageInspection) {
...
/// Print file listing
pub(super) fn print_files(pkg: &UntrustedPackageInspection) {
...
/// Print hooks
pub(super) fn print_hooks(pkg: &UntrustedPackageInspection) {
...
/// Print dependencies
pub(super) fn print_dependencies(pkg: &UntrustedPackageInspection) {
    println!("Provides:");
...
pub(super) fn print_json(
    ...
    struct JsonOutput<'a> {
        ...
        #[serde(skip_serializing_if = "Option::is_none")]
        hooks: Option<&'a conary_core::ccs::manifest::Hooks>,
        #[serde(skip_serializing_if = "Option::is_none")]
        provides: Option<&'a conary_core::ccs::manifest::Provides>,
        #[serde(skip_serializing_if = "Option::is_none")]
        requirements:
            Option<&'a Vec<conary_core::repository::dependency_model::RepositoryRequirementGroup>>,
    }
