...
async fn dispatch_cache_command(cmd: cli::CacheCommands) -> Result<()> {
    match cmd {
...
async fn dispatch_repo_command(repo_cmd: cli::RepoCommands) -> Result<()> {
    match repo_cmd {
...
async fn dispatch_config_command(config_cmd: cli::ConfigCommands) -> Result<()> {
    match config_cmd {
...
async fn dispatch_query_command(query_cmd: cli::QueryCommands) -> Result<()> {
    match query_cmd {
...
async fn dispatch_collection_command(coll_cmd: cli::CollectionCommands) -> Result<()> {
    match coll_cmd {
...
async fn dispatch_derive_command(derive_cmd: cli::DeriveCommands) -> Result<()> {
    match derive_cmd {
...
async fn dispatch_bootstrap_command(bootstrap_cmd: cli::BootstrapCommands) -> Result<()> {
    match bootstrap_cmd {
...
async fn dispatch_provenance_command(cmd: cli::ProvenanceCommands) -> Result<()> {
    match cmd {
...
async fn dispatch_capability_command(cmd: cli::CapabilityCommands) -> Result<()> {
    match cmd {
...
async fn dispatch_trust_command(cmd: cli::TrustCommands) -> Result<()> {
    match cmd {
...
async fn dispatch_federation_command(cmd: cli::FederationCommands) -> Result<()> {
    match cmd {
...
async fn dispatch_distro_command(distro_cmd: cli::DistroCommands) -> Result<()> {
    match distro_cmd {
...
async fn dispatch_canonical_command(can_cmd: cli::CanonicalCommands) -> Result<()> {
    match can_cmd {
...
async fn dispatch_groups_command(grp_cmd: cli::GroupsCommands) -> Result<()> {
    match grp_cmd {
...
async fn dispatch_registry_command(reg_cmd: cli::RegistryCommands) -> Result<()> {
    match reg_cmd {
...
async fn dispatch_derivation_command(derivation_cmd: cli::DerivationCommands) -> Result<()> {
...
async fn dispatch_profile_command(profile_cmd: cli::ProfileCommands) -> Result<()> {
    match profile_cmd {
...
async fn dispatch_verify_derivation_command(verify_cmd: cli::VerifyCommands) -> Result<()> {
    match verify_cmd {
