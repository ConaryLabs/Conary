// apps/remi/src/federation/mdns.rs
    ...
    match event {
        ServiceEvent::ServiceResolved(info) => {
            ...
            let node_id = properties
                .get("node_id")
                .cloned()
                .unwrap_or_else(|| conary_core::hash::sha256(info.get_fullname().as_bytes()));
        ...
        ServiceEvent::ServiceRemoved(_, fullname) => {
            ...
            let peer_id = conary_core::hash::sha256(fullname.as_bytes());
