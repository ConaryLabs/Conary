...
use super::super::schema::PackageDataV3;
...
pub(super) fn validate_file_capabilities(
    ...
    match super::super::file_capabilities::canonicalize_file_capabilities(capabilities) {
        Ok(canonical) if canonical != capabilities => diagnostics.push(V3Diagnostic::error(
        ...
        Err(error) => diagnostics.push(V3Diagnostic::error(
            V3DiagnosticCode::KindContractViolation,
...
mod tests {
    ...
    use crate::ccs::v3::validation::validate_authority;
    ...
    fn rejects_missing_and_non_regular_signed_targets() {
        let mut missing = AuthorityDocumentV3::package_for_tests("missing-target");
        ...
        let mut symlink = AuthorityDocumentV3::package_for_tests("symlink-target");
        let PackageKindV3::Package(data) = &mut symlink.kind else {
    ...
    fn rejects_duplicate_paths_and_noncanonical_capability_names() {
        ...
        let mut duplicate = AuthorityDocumentV3::package_for_tests("duplicate");
        ...
        let mut unordered = AuthorityDocumentV3::package_for_tests("unordered");
