...
CREATE TABLE repositories (
        ...
        , gpg_strict INTEGER NOT NULL DEFAULT 0, content_url TEXT, default_strategy TEXT, default_strategy_endpoint TEXT, default_strategy_distro TEXT, tuf_enabled INTEGER NOT NULL DEFAULT 0, tuf_root_version INTEGER, tuf_root_url TEXT, distro TEXT, security_advisory_support TEXT NOT NULL DEFAULT 'unknown'
...
CREATE TABLE repository_packages (
            ...
            dependencies TEXT,
            metadata TEXT,
            synced_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, is_security_update INTEGER NOT NULL DEFAULT 0, severity TEXT, cve_ids TEXT, advisory_id TEXT, advisory_url TEXT, distro TEXT, version_scheme TEXT, canonical_id INTEGER
...
CREATE TABLE repository_requirements (
            ...
            raw TEXT, group_id INTEGER REFERENCES repository_requirement_groups(id) ON DELETE CASCADE,
            FOREIGN KEY (repository_package_id) REFERENCES repository_packages(id) ON DELETE CASCADE
        );
