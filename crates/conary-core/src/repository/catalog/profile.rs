...
use super::{
    CatalogBindingV1, CatalogContentV1, CatalogPackageOriginV1, CatalogReader, CatalogScopeV1,
    CatalogSourceEvidenceV1, PROFILE_REVISION_SCHEMA_V1, ProfileRevisionV1, ProfileSourceMemberV1,
    SourceSnapshotV1,
};
...
impl ProfileCatalogCandidateV1 {
    pub fn compose(
        ...
        for (index, input) in inputs.into_iter().enumerate() {
            ...
            for mut package in input.reader.packages()? {
