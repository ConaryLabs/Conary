...
pub use sync::{
    ...
    RepositoryWriteAuthority, abort_profile_sync_run, acknowledge_profile_sync_candidate_cleanup,
    ...
    stream_native_source_catalog, stream_native_source_catalog_with_scratch_admission,
