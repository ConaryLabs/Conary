...
The verifier imposes no aggregate transport ceiling absent from the producer
contract, while confining every member read to the actual plain archive extent.
