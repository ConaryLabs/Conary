...
solely to discover and union residual hard required edges under that same
visibility. Edges owned by a shadowed provider are validated but excluded from
both the original problem projection and the relaxed probe. That diagnostic
