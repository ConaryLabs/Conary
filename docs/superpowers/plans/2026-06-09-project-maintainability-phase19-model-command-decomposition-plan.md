...
- `docs/superpowers/plans/2026-06-09-project-maintainability-phase19-model-command-decomposition-plan.md`
...
```text
origin_path = docs/superpowers/plans/2026-06-09-project-maintainability-phase19-model-command-decomposition-plan.md
path = docs/superpowers/plans/2026-06-09-project-maintainability-phase19-model-command-decomposition-plan.md
family = planning
audience = maintainer
status = verified
...
Plan file: docs/superpowers/plans/2026-06-09-project-maintainability-phase19-model-command-decomposition-plan.md
