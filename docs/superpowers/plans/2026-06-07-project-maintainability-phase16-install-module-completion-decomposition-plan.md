...
- Add: `docs/superpowers/plans/2026-06-07-project-maintainability-phase16-install-module-completion-decomposition-plan.md`

- [ ] **Step 1: Stage the plan file before inventory regeneration**

```bash
git add docs/superpowers/plans/2026-06-07-project-maintainability-phase16-install-module-completion-decomposition-plan.md
```
...
- Add the Phase 16 plan path to `evidence_sources`:
  `docs/superpowers/plans/2026-06-07-project-maintainability-phase16-install-module-completion-decomposition-plan.md`
