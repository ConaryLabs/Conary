...
**Files:**
- Modify: `scripts/docs-audit-inventory.sh`
- Add: `docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md`
- Modify: `docs/superpowers/documentation-accuracy-audit-summary.md`
...
```bash
git add scripts/docs-audit-inventory.sh docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md
```
...
```text
docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md	docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md	planning	maintainer	maintainability; phase2; dead-surface-pruning; stale-surface-inventory	AGENTS.md; CONTRIBUTING.md; docs/llms/README.md; docs/llms/subsystem-map.md; docs/superpowers/plans/2026-06-06-project-maintainability-agent-readiness-roadmap.md; docs/superpowers/plans/2026-06-05-ccs-native-ecosystem-roadmap.md; data/distros.toml; apps/conary/src/cli/repo.rs; apps/conary/src/commands/ccs/init.rs; apps/remi/src/bin/remi.rs; scripts/docs-audit-inventory.sh; scripts/check-doc-audit-ledger.sh	verified	corrected	Added the reviewed Phase 2 implementation plan for the first dead-surface pruning slice: portable docs-audit inventory filtering, tested public CLI help cleanup, current supported-target wording, CCS init command-name correction, and a pruning inventory artifact.
```
...
```text
docs/superpowers/documentation-accuracy-audit-summary.md	docs/superpowers/documentation-accuracy-audit-summary.md	planning	maintainer	audit-summary; verification; release-hardening; active-planning; maintainability	docs/superpowers/documentation-accuracy-audit-ledger.tsv; docs/superpowers/documentation-accuracy-audit-inventory.tsv; scripts/check-doc-audit-ledger.sh; ROADMAP.md; docs/superpowers/plans/2026-06-06-project-maintainability-agent-readiness-roadmap.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase1-repo-discipline-contract-plan.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md	verified	corrected	Refreshed the audit summary for the active maintainability planning lane, current docs-audit counts, Phase 1 discipline contract, and Phase 2 dead-surface pruning plan.
```
...
```bash
git add scripts/docs-audit-inventory.sh docs/superpowers/documentation-accuracy-audit-summary.md docs/superpowers/documentation-accuracy-audit-inventory.tsv docs/superpowers/documentation-accuracy-audit-ledger.tsv docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md
...
```text
docs/superpowers/project-maintainability-dead-surface-inventory-2026-06-06.md	docs/superpowers/project-maintainability-dead-surface-inventory-2026-06-06.md	planning	maintainer	maintainability; phase2; dead-surface-inventory; pruning-queue	AGENTS.md; docs/llms/README.md; docs/superpowers/plans/2026-06-06-project-maintainability-agent-readiness-roadmap.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md; data/distros.toml; apps/conary/src/cli/repo.rs; apps/conary/src/commands/ccs/init.rs; apps/remi/src/bin/remi.rs	verified	corrected	Added the Phase 2 dead-surface inventory with fixed public CLI strings, intentional internal/parser/archive surfaces, deferred behavior-changing candidates, and refresh commands.
```
...
```text
docs/superpowers/documentation-accuracy-audit-summary.md	docs/superpowers/documentation-accuracy-audit-summary.md	planning	maintainer	audit-summary; verification; release-hardening; active-planning; maintainability	docs/superpowers/documentation-accuracy-audit-ledger.tsv; docs/superpowers/documentation-accuracy-audit-inventory.tsv; scripts/check-doc-audit-ledger.sh; ROADMAP.md; docs/superpowers/plans/2026-06-06-project-maintainability-agent-readiness-roadmap.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase1-repo-discipline-contract-plan.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md; docs/superpowers/project-maintainability-dead-surface-inventory-2026-06-06.md	verified	corrected	Refreshed the audit summary for the active maintainability planning lane, current docs-audit counts, Phase 1 discipline contract, Phase 2 dead-surface pruning plan, and the Phase 2 pruning inventory.
```
...
stale_matches="$(
    grep -R -n -E "ccs-build|conary ccs-build|Examples: fedora, arch, debian, ubuntu|arch, fedora, ubuntu, debian|fedora, ubuntu, debian|Distribution to generate index for \\(arch, fedora, ubuntu, debian\\)|Distribution to pre-warm \\(arch, fedora, ubuntu, debian\\)|Distribution to benchmark, such as fedora, ubuntu, debian, or arch" apps docs README.md CONTRIBUTING.md .github \
        | grep -v -E "^(docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md|docs/superpowers/project-maintainability-dead-surface-inventory-2026-06-06.md|[^:]+/archive/)" || true
)"
