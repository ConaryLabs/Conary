...
- `docs/superpowers/plans/2026-06-09-project-maintainability-phase20-ccs-scriptlet-bundle-decomposition-plan.md`
...
```text
origin_path = docs/superpowers/plans/2026-06-09-project-maintainability-phase20-ccs-scriptlet-bundle-decomposition-plan.md
path = docs/superpowers/plans/2026-06-09-project-maintainability-phase20-ccs-scriptlet-bundle-decomposition-plan.md
family = planning
audience = maintainer
status = verified
...
```bash
git add docs/superpowers/plans/2026-06-09-project-maintainability-phase20-ccs-scriptlet-bundle-decomposition-plan.md \
    docs/superpowers/documentation-accuracy-audit-ledger.tsv \
    docs/superpowers/documentation-accuracy-audit-inventory.tsv \
    docs/superpowers/documentation-accuracy-audit-summary.md
