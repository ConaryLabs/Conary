...
- Add: `docs/superpowers/plans/2026-06-09-project-maintainability-phase21-dispatch-decomposition-plan.md`
...
```bash
git add -N docs/superpowers/plans/2026-06-09-project-maintainability-phase21-dispatch-decomposition-plan.md
```
...
```bash
git add docs/superpowers/plans/2026-06-09-project-maintainability-phase21-dispatch-decomposition-plan.md docs/superpowers/documentation-accuracy-audit-ledger.tsv docs/superpowers/documentation-accuracy-audit-summary.md docs/superpowers/documentation-accuracy-audit-inventory.tsv
...
docs/superpowers/plans/2026-06-09-project-maintainability-phase21-dispatch-decomposition-plan.md
```
