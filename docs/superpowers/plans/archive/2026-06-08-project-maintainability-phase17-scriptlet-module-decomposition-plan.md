...
- Add: `docs/superpowers/plans/archive/2026-06-08-project-maintainability-phase17-scriptlet-module-decomposition-plan.md`

- [ ] **Step 1: Stage the plan file before inventory regeneration**

```bash
git add docs/superpowers/plans/archive/2026-06-08-project-maintainability-phase17-scriptlet-module-decomposition-plan.md
```
...
- Add the Phase 17 plan path to `evidence_sources`:
  `docs/superpowers/plans/archive/2026-06-08-project-maintainability-phase17-scriptlet-module-decomposition-plan.md`
