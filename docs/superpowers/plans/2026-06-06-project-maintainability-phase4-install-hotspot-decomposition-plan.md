...
**Files:**
- Add: `docs/superpowers/plans/2026-06-06-project-maintainability-phase4-install-hotspot-decomposition-plan.md`
...
```bash
git add docs/superpowers/plans/2026-06-06-project-maintainability-phase4-install-hotspot-decomposition-plan.md
```
...
```text
docs/superpowers/plans/2026-06-06-project-maintainability-phase4-install-hotspot-decomposition-plan.md	planning	maintainer
```
...
```bash
git add docs/superpowers/plans/2026-06-06-project-maintainability-phase4-install-hotspot-decomposition-plan.md docs/superpowers/documentation-accuracy-audit-inventory.tsv docs/superpowers/documentation-accuracy-audit-ledger.tsv docs/superpowers/documentation-accuracy-audit-summary.md
...
docs/superpowers/documentation-accuracy-audit-summary.md	docs/superpowers/documentation-accuracy-audit-summary.md	planning	maintainer	audit-summary; verification; release-hardening; active-planning; maintainability	docs/superpowers/documentation-accuracy-audit-ledger.tsv; docs/superpowers/documentation-accuracy-audit-inventory.tsv; scripts/check-doc-audit-ledger.sh; ROADMAP.md; docs/superpowers/plans/2026-06-06-project-maintainability-agent-readiness-roadmap.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase1-repo-discipline-contract-plan.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase2-dead-surface-pruning-plan.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase3-test-fixture-discipline-plan.md; docs/superpowers/plans/2026-06-06-project-maintainability-phase4-install-hotspot-decomposition-plan.md; docs/modules/test-fixtures.md; docs/llms/subsystem-map.md; docs/modules/ccs.md; docs/modules/remi.md; docs/superpowers/project-maintainability-dead-surface-inventory-2026-06-06.md	verified	corrected	Refreshed the audit summary for the active maintainability planning lane, current docs-audit counts, Phase 1 discipline contract, Phase 2 dead-surface pruning plan and inventory, Phase 3 fixture-discipline plan, and Phase 4 install hotspot decomposition plan.
```
