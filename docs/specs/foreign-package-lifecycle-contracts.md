...
Current-only database schema revision 53 retains the tagged
...
promotion-evidence and complete-crawl digests it consumed. Earlier databases
must be rebuilt; no compatibility decoder or migration exists.
